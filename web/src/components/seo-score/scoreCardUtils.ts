...
export const SCORE_FIELDS = [
  ...
  { key: 'ai_citability_score', label: 'AI Alintılanabilirlik', max: 10, description: 'Aciklamanin ChatGPT/Perplexity gibi yapay zekalar tarafından kaynak gösterilme potansiyeli (istatistik, teknik veri, objektif dil).' },
] as const;
